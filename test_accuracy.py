...
TEST_IMAGE_DIR = '/media/krishna_warrior/B8006E18006DDDBE/linux_copy/training_traffic_dataset/GTSRB/Final_Test/Images'
...
'''with Session() as session:
   ...
   session.load('checkpoint/network3_epochs5.ckpt')
