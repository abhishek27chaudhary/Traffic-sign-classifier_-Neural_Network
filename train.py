...
TRAIN_IMAGE_DIR='/home/krishna_warrior/Desktop/dataset'         #dataset path.
dfs=[]
...
print('X data',len(X))
X_train, X_valid,y_train, y_valid=train_test_split(X,y,stratify=y,test_size=329,random_state=0)
